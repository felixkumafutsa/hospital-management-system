...
async function main() {
  ...
  const [adminRole, doctorRole, nurseRole, receptionistRole, labTechRole, pharmacistRole, cashierRole] = roles;
  ...
  console.log('✅ Created all 6 staff users');
  ...
  console.log('✅ Created 6 lab tests');
  ...
  console.log('✅ Created medicines and batches');
  ...
  await prisma.visit.create({
    data: {
      ...
      expectedDischargeDate: new Date(Date.now() + 259200000),
      dailyRate: 15000.00,
      createdBy: adminUser.id,
    }
  });
  ...
  // ==========================================
  // STEP 10: Create Vitals
  // ==========================================
  await prisma.vital.create({
    data: {
      visitId: (await prisma.visit.findFirst({where: {patientId: patient3.id}})).id,
  ...
  // ==========================================
  // STEP 11: Create ANC Record
  // ==========================================
  await prisma.ancRecord.create({
    data: {
      patientId: patient2.id,
      gestationWeeks: 24,
      visitDate: new Date(Date.now() - 604800000),
      ...
      nextVisitDate: new Date(Date.now() + 604800000),
    }
  });
